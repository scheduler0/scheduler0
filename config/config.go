...
type Scheduler0Configurations struct {
	...
	InActiveFollowerTimeoutToRequestJobsFromLeader int        `json:"inActiveFollowerTimeoutToRequestJobsFromLeader" yaml:"InActiveFollowerTimeoutToRequestJobsFromLeader"`
