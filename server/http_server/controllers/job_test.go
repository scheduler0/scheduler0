...
import (
	...
	jobController "scheduler0/server/http_server/controllers"
	jobTestFixtures "scheduler0/server/http_server/controllers/fixtures"
...
var _ = Describe("Job Controller", func() {
	...
	Context("TestJobController_GetAll", func() {
		It("Respond with status 200 and return all created jobs", func() {
			projectTransformers := fixtures.CreateProjectTransformerFixture()
