...
import (
	...
	fixtures2 "scheduler0/server/repository/fixtures"
	"scheduler0/utils"
	"strconv"
	"testing"
)
...
var _ = Describe("Project Repo", func() {
	...
	It("Don't create project with existing name", func() {
		...
		projectManagerOne := models.ProjectModel{
			Name:        projectFixture.Name,
			Description: projectFixture.Description,
		}

		projectManagerTwo := models.ProjectModel{
			Name:        projectFixture.Name,
			Description: projectFixture.Description,
		}
	...
	It("Can retrieve a single project by uuid", func() {
		...
		projectManagerByName := models.ProjectModel{
			ID: projectModel.ID,
		}
	...
	It("Can retrieve a single project by name", func() {
		...
		projectByName := models.ProjectModel{
	...
	It("Can update name and description for a project", func() {
		...
		projectTwoPlaceholder := models.ProjectModel{
			ID:   projectModel.ID,
			Name: projectFixture.Name,
		}
	...
	It("Delete All Projects", func() {
		...
		projectManager := models.ProjectModel{
			Name:        projectFixture.Name,
			Description: projectFixture.Description,
		}
