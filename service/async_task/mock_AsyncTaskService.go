...
// MockAsyncTaskService is an autogenerated mock type for the AsyncTaskService type
type MockAsyncTaskService struct {
	mock.Mock
}

// AddSubscriber provides a mock function with given fields: taskId, subscriber
func (_m *MockAsyncTaskService) AddSubscriber(taskId uint64, subscriber func(models.AsyncTask)) (uint64, *utils.GenericError) {
...
func (_m *MockAsyncTaskService) AddTasks(input string, requestId string, service string) ([]uint64, *utils.GenericError) {
...
func (_m *MockAsyncTaskService) DeleteSubscriber(taskId uint64, subscriberId uint64) *utils.GenericError {
...
func (_m *MockAsyncTaskService) GetSingleNodeMode() bool {
	ret := _m.Called()
...
func (_m *MockAsyncTaskService) GetTaskBlocking(taskId uint64) (chan models.AsyncTask, uint64, *utils.GenericError) {
...
func (_m *MockAsyncTaskService) GetTaskIdWithRequestId(requestId string) (uint64, *utils.GenericError) {
...
func (_m *MockAsyncTaskService) GetTaskWithRequestIdBlocking(requestId string) (chan models.AsyncTask, uint64, *utils.GenericError) {
	ret := _m.Called(requestId)
...
func (_m *MockAsyncTaskService) GetTaskWithRequestIdNonBlocking(requestId string) (*models.AsyncTask, *utils.GenericError) {
	ret := _m.Called(requestId)
...
func (_m *MockAsyncTaskService) GetUnCommittedTasks() ([]models.AsyncTask, *utils.GenericError) {
	ret := _m.Called()
...
func (_m *MockAsyncTaskService) ListenForNotifications() {
	_m.Called()
}

// SetSingleNodeMode provides a mock function with given fields: singleNodeMode
func (_m *MockAsyncTaskService) SetSingleNodeMode(singleNodeMode bool) {
	_m.Called(singleNodeMode)
}

// UpdateTasksById provides a mock function with given fields: taskId, state, output
func (_m *MockAsyncTaskService) UpdateTasksById(taskId uint64, state models.AsyncTaskState, output string) *utils.GenericError {
...
func (_m *MockAsyncTaskService) UpdateTasksByRequestId(requestId string, state models.AsyncTaskState, output string) *utils.GenericError {
...
type mockConstructorTestingTNewMockAsyncTaskService interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockAsyncTaskService creates a new instance of MockAsyncTaskService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockAsyncTaskService(t mockConstructorTestingTNewMockAsyncTaskService) *MockAsyncTaskService {
	mock := &MockAsyncTaskService{}
	mock.Mock.Test(t)
