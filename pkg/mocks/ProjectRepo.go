...
func (_m *ProjectRepo) CreateOne(project *models.Project) (uint64, *utils.GenericError) {
	ret := _m.Called(project)

	var r0 uint64
	var r1 *utils.GenericError
	if rf, ok := ret.Get(0).(func(*models.Project) (uint64, *utils.GenericError)); ok {
		return rf(project)
	}
	if rf, ok := ret.Get(0).(func(*models.Project) uint64); ok {
		r0 = rf(project)
	} else {
		r0 = ret.Get(0).(uint64)
	}
...
func (_m *ProjectRepo) DeleteOneByID(project models.Project) (uint64, *utils.GenericError) {
	ret := _m.Called(project)
...
func (_m *ProjectRepo) GetBatchProjectsByIDs(projectIds []uint64) ([]models.Project, *utils.GenericError) {
...
func (_m *ProjectRepo) GetOneByID(project *models.Project) *utils.GenericError {
	ret := _m.Called(project)
...
func (_m *ProjectRepo) GetOneByName(project *models.Project) *utils.GenericError {
	ret := _m.Called(project)
...
func (_m *ProjectRepo) List(offset uint64, limit uint64) ([]models.Project, *utils.GenericError) {
	ret := _m.Called(offset, limit)

	var r0 []models.Project
	var r1 *utils.GenericError
	if rf, ok := ret.Get(0).(func(uint64, uint64) ([]models.Project, *utils.GenericError)); ok {
		return rf(offset, limit)
	}
	if rf, ok := ret.Get(0).(func(uint64, uint64) []models.Project); ok {
		r0 = rf(offset, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.Project)
...
func (_m *ProjectRepo) UpdateOneByID(project models.Project) (uint64, *utils.GenericError) {
	ret := _m.Called(project)
