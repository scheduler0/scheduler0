...
func (_m *Project) BatchGetProjects(projectIds []uint64) ([]models.Project, *utils.GenericError) {
...
func (_m *Project) CreateOne(project models.Project) (*models.Project, *utils.GenericError) {
...
func (_m *Project) DeleteOneByID(project models.Project) *utils.GenericError {
	ret := _m.Called(project)
...
func (_m *Project) GetOneByID(project *models.Project) *utils.GenericError {
	ret := _m.Called(project)
...
func (_m *Project) GetOneByName(project *models.Project) *utils.GenericError {
	ret := _m.Called(project)
...
func (_m *Project) List(offset uint64, limit uint64) (*models.PaginatedProject, *utils.GenericError) {
...
func (_m *Project) UpdateOneByID(project *models.Project) *utils.GenericError {
	ret := _m.Called(project)
