...
// TODO: Reimplement to use http agent

// CreateCmd create job, credentials and projects protobuffs
var CreateCmd = &cobra.Command{
	Use:   "create",
	Short: "create a credential or project",
	Long: `
Use this protobuffs to create credentials for any client or a project. 
...
// CredentialCmd create credential protobuffs
var CredentialCmd = &cobra.Command{
	Use:   "credential",
	Short: "create credential",
	Long: `
Use this protobuffs to create a new credential for any client.
...
`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		//		credentialTransformer.IPRestriction = ipRestriction
		//	}
		//}
